    ...
    <div class="content">
        ...
        <div class="about-card">
            <div class="profile-photo">
                <img src="{{ asset('images/Farellivia.jpg') }}" alt="Foto Profil Ardita">
            </div>
            <div class="info">
                <p>Aplikasi ini dibuat oleh:</p>
                <p>
                    <strong>Nama</strong> : Farellivia Rizky Apriyananda<br>
                    <strong>Prodi</strong> : D3 Manajemen Informatika POLINEMA PSDKU Kediri<br>
                    <strong>NIM</strong> : 2331730032<br>
